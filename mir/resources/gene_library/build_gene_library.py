...
Usage::
    ...
    python mir/resources/gene_library/build_gene_library.py           # build both + check
    python mir/resources/gene_library/build_gene_library.py --olga    # OLGA only
    python mir/resources/gene_library/build_gene_library.py --imgt    # IMGT only
    python mir/resources/gene_library/build_gene_library.py --check   # consistency only
