...
def _mk_clonotype(
    ...
    aa: str,
    *,
    v_call: str = "TRBV7-9*01",
    j_call: str = "TRBJ2-1*01",
    ...
    return Clonotype(
        ...
        locus="TRB",
        junction_aa=aa,
        v_call=allele_to_major(v_call),
        j_call=allele_to_major(j_call),
    ...
    *,
    ...
    clonotypes = [
        _mk_clonotype(
            ...
            v_call=str(rec.get("v_call", "TRBV7-9*01")),
            j_call=str(rec.get("j_call", "TRBJ2-1*01")),
