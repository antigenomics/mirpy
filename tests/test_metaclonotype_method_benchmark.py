    ...
    for i in range(n):
        ...
        clonotypes.append(
            Clonotype(
                ...
                v_gene=rng.choice(_TRBV_GENES),
                j_gene=rng.choice(_TRBJ_GENES),
    ...
    for i in range(n):
        ...
        clonotypes.append(
            Clonotype(
                ...
                locus="TRA",
                junction_aa=_random_aa(rng, length),
                v_gene=rng.choice(_TRAV_GENES),
                j_gene=rng.choice(_TRAJ_GENES),
                duplicate_count=rng.randint(1, 1000),
                _validate=False,
            )
        )
        ...
        pairs.append(
            PairedClonotype(
                ...
                clonotype1=Clonotype(
                    ...
                    v_gene=tra_rng.choice(_TRAV_GENES),
                    j_gene=tra_rng.choice(_TRAJ_GENES),
                    duplicate_count=1,
                    _validate=False,
                ),
                clonotype2=Clonotype(
                    ...
                    v_gene=trb_rng.choice(_TRBV_GENES),
                    j_gene=trb_rng.choice(_TRBJ_GENES),
                    duplicate_count=1,
                    _validate=False,
                ),
            )
